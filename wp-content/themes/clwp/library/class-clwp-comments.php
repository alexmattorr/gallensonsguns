...
if ( ! class_exists( 'CLWP_Comments' ) ) :
class CLWP_Comments extends Walker_Comment {
	...
	function __construct() { ?>
		...
		<h3><?php comments_number( __( 'No Responses to', 'clwp' ), __( 'One Response to', 'clwp' ), __( '% Responses to', 'clwp' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
